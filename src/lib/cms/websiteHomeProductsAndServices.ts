const FALLBACK_BACKGROUND = "/images/home/products-and-services.webp";
const DEFAULT_CTA_HREF = "/vouchers";

export type ProductsAndServicesSectionResolved = {
  backgroundImageSrc: string;
  backgroundAlt: string;
  /** Single storefront destination from `config.config.link`. */
  ctaHref: string;
};
...
const DEFAULT_RESOLVED: ProductsAndServicesSectionResolved = {
...
/**
 * Resolves the home “Products and services” full-bleed banner from `CmsSitePublic.home_page`
 * (`block_type` BANNER, `code` PRODUCTS_AND_SERVICES`).
 */
export function resolveProductsAndServicesSection(
  homePage: unknown
): ProductsAndServicesSectionResolved {
